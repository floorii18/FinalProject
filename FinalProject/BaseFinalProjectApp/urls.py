...
urlpatterns = [
    ...
    path('addcertifications/', views.addCertification, name="addcertifications"),
    path('deletecertifications/', views.deleteCertification, name="deletecertifications"),
    path('updatecertifications/', views.updateCertification, name="updatecertifications"),
