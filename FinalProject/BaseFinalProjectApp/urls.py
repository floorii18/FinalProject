...
urlpatterns = [
    ...
    path('deletecertification/<str:certification_title>/', views.DeleteCertification, name='deletecertification'),
    path('updatecertification/<str:certification_title>/', views.UpdateCertification, name='updatecertification'),
